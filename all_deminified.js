/*1311291177,169554540,JIT Construction: v409162,en_US*/
...
FB.provide('UIServer', {
    ...
    popup: function(b) {
        ...
        if (b.params && (b.params.method == 'permissions.request' || b.params.method == 'permissions.oauth')) c += ',location=1,toolbar=0';
        if (b.post) {
