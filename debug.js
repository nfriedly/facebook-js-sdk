/*1456158548,,JIT Construction: v2193758,en_US*/
...
return call;},{params:[[call,'object','call']],returns:'?object'});},{'module':'sdk.UIServer','line':123,'column':13,'endLine':182,'endColumn':5},{params:['object'],returns:'?object'})},
...
Auth.getAuthResponse(),
'logout');
return call;}},{params:[[call,'object','call']],returns:'?object'});},{'module':'sdk.UIServer','line':187,'column':13,'endLine':200,'endColumn':5},{params:['object'],returns:'?object'})},
...
return call;},{params:[[call,'object','call']],returns:'object'});},{'module':'sdk.UIServer','line':205,'column':13,'endLine':223,'endColumn':5},{params:['object'],returns:'object'})},
...
return call;},{params:[[call,'object','call']],returns:'object'});},{'module':'sdk.UIServer','line':286,'column':18,'endLine':295,'endColumn':3},{params:['object'],returns:'object'}),
...
return params.display;},{'module':'sdk.UIServer','line':301,'column':19,'endLine':315,'endColumn':3}),
...
return call;},{params:[[params,'object','params'],[cb,'function','cb']],returns:'?object'});},{'module':'sdk.UIServer','line':325,'column':13,'endLine':449,'endColumn':3},{params:['object','function'],returns:'?object'}),
...
return call;},{params:[[call,'object','call']],returns:'object'});},{'module':'sdk.UIServer','line':451,'column':15,'endLine':475,'endColumn':3},{params:['object'],returns:'object'}),


urlTooLongForIE:__annotator(function(fullURL){return __bodyWrapper(this,arguments,function(){
return UA.ie() && UA.ie() <= 8 && fullURL.length > 2048;},{params:[[fullURL,'string','fullURL']],returns:'boolean'});},{'module':'sdk.UIServer','line':477,'column':17,'endLine':479,'endColumn':3},{params:['string'],returns:'boolean'}),
...
return params.display || (UIServer.canIframe(params)?'dialog':'popup');},{params:[[method,'object','method'],[params,'object','params']],returns:'string'});},{'module':'sdk.UIServer','line':488,'column':16,'endLine':519,'endColumn':3},{params:['object','object'],returns:'string'}),
...
return false;},{params:[[params,'object','params']],returns:'boolean'});},{'module':'sdk.UIServer','line':521,'column':11,'endLine':531,'endColumn':3},{params:['object'],returns:'boolean'}),
...
if(display === 'async'){
return 'parent.frames[' + window.name + ']';}},{params:[[params,'object','params']],returns:'string'});},{'module':'sdk.UIServer','line':539,'column':15,'endLine':551,'endColumn':3},{params:['object'],returns:'string'}),
...
if(call.id in UIServer._defaultCb){
UIServer._popupMonitor();}},{params:[[call,'object','call']]});},{'module':'sdk.UIServer','line':559,'column':7,'endLine':628,'endColumn':3},{params:['object']}),
...
UIServer._loadedNodes[call.id] = node;},{params:[[call,'object','call'],[type,'?string','type']]});},{'module':'sdk.UIServer','line':630,'column':15,'endLine':640,'endColumn':3},{params:['object','?string']}),


getLoadedNode:__annotator(function(call){
var id=typeof call == 'object'?call.id:call,
node=UIServer._loadedNodes[id];
return node?node.node:null;},{'module':'sdk.UIServer','line':642,'column':15,'endLine':646,'endColumn':3}),
...
UIServer._insertIframe(call);},{params:[[call,'object','call']]});},{'module':'sdk.UIServer','line':653,'column':8,'endLine':657,'endColumn':3},{params:['object']}),
...
UIServer._insertIframe(call);},{params:[[call,'object','call']]});},{'module':'sdk.UIServer','line':664,'column':8,'endLine':692,'endColumn':3},{params:['object']}),
...
UIServer.popup(call);}},{params:[[call,'object','call']]});},{'module':'sdk.UIServer','line':700,'column':7,'endLine':732,'endColumn':3},{params:['object']}),
...
call.cb(result);},{params:[[response,'object','response']]});},{'module':'sdk.UIServer','line':749,'column':6,'endLine':759,'endColumn':7},{params:['object']}));},{params:[[call,'object','call']]});},{'module':'sdk.UIServer','line':741,'column':7,'endLine':761,'endColumn':3},{params:['object']}),




getDefaultSize:__annotator(function(){return __bodyWrapper(this,arguments,function(){
return Dialog.getDefaultSize();},{returns:'object'});},{'module':'sdk.UIServer','line':763,'column':16,'endLine':765,'endColumn':3},{returns:'object'}),
...
id:call.id,
name:call.frameName,
onInsert:activate});}},{params:[[call,'object','call']]});},{'module':'sdk.UIServer','line':772,'column':15,'endLine':813,'endColumn':3},{params:['object']}),
...
{
Dialog._centerActive();}},{params:[[frame,'string','frame'],[data,'object','data']]});},{'module':'sdk.UIServer','line':820,'column':22,'endLine':843,'endColumn':3},{params:['string','object']}),
...
UIServer._xdRecv(
data,
UIServer._defaultCb[id] || __annotator(function(){},{'module':'sdk.UIServer','line':858,'column':33,'endLine':858,'endColumn':46}));},{params:[[id,'string','id'],[result,'?string','result']]});},{'module':'sdk.UIServer','line':851,'column':17,'endLine':860,'endColumn':3},{params:['string','?string']}),
...
UIServer._popupInterval = null;}},{'module':'sdk.UIServer','line':868,'column':15,'endLine':902,'endColumn':3}),
...
relation,true,null);},{params:[[frame,'string','frame'],[relation,'string','relation']],returns:'string'});},{'module':'sdk.UIServer','line':912,'column':19,'endLine':931,'endColumn':3},{params:['string','string'],returns:'string'}),
...
relation) + '&frame=' + frame;},{params:[[cb,'function','cb'],[frame,'string','frame'],[relation,'string','relation'],[isDefault,'boolean','isDefault']],returns:'string'});},{'module':'sdk.UIServer','line':944,'column':16,'endLine':953,'endColumn':3},{params:['function','string','string','boolean'],returns:'string'}),
...
cb(data);},{params:[[data,'object','data'],[cb,'function','cb']]});},{'module':'sdk.UIServer','line':963,'column':9,'endLine':1006,'endColumn':3},{params:['object','function']}),
...
'&result=' + encodeURIComponent(UIServer._resultToken));},{params:[[cb,'function','cb'],[frame,'string','frame'],[target,'string','target'],[isDefault,'boolean','isDefault']],returns:'string'});},{'module':'sdk.UIServer','line':1019,'column':11,'endLine':1030,'endColumn':3},{params:['function','string','string','boolean'],returns:'string'}),
...
frame,
target,
true);},{params:[[cb,'function','cb'],[frame,'string','frame'],[target,'string','target'],[authResponse,'?object','authResponse'],[method,'string','method']],returns:'string'});},{'module':'sdk.UIServer','line':1032,'column':11,'endLine':1039,'endColumn':3},{params:['function','string','string','?object','string'],returns:'string'})};
...
this._iframeOptions.url = url + QueryString.encode(this._params);}}},{params:[[elem,'HTMLElement','elem'],[ns,'string','ns'],[tag,'string','tag'],[attr,'object','attr']]});},{'module':'IframePlugin','line':130,'column':13,'endLine':279,'endColumn':3},{params:['HTMLElement','string','string','object']}),
...
ES('Object','assign',false,this._iframe.style,iframeStyle);}}},{'module':'IframePlugin','line':281,'column':9,'endLine':377,'endColumn':3}),
...
return {};},{returns:'object'});},{'module':'IframePlugin','line':382,'column':11,'endLine':384,'endColumn':3},{returns:'object'}),


isFluid:__annotator(function(){
var config=this.getConfig();
return config.fluid;},{'module':'IframePlugin','line':386,'column':9,'endLine':389,'endColumn':3}),
...
params:ES('JSON','stringify',false,params)});},{'module':'IframePlugin','line':391,'column':12,'endLine':426,'endColumn':3}),
...
DOM[same?'removeCss':'addCss'](this._iframe,'fb_iframe_widget_lift');},{'module':'IframePlugin','line':428,'column':12,'endLine':433,'endColumn':3})},
...
return params;},{'module':'IframePlugin','line':443,'column':13,'endLine':445,'endColumn':5}),


getConfig:__annotator(function(){return __bodyWrapper(this,arguments,function(){
return config?config:{};},{returns:'object'});},{'module':'IframePlugin','line':447,'column':13,'endLine':449,'endColumn':5},{returns:'object'})});},{params:[[params,'object','params'],[config,'?object','config']],returns:'function'});},{'module':'IframePlugin','line':438,'column':26,'endLine':451,'endColumn':1},{params:['object','?object'],returns:'function'});
...
controls:'bool',
href:'url',
showpostcontent:'bool'};},{returns:'object'});},{'module':'sdk.XFBML.Video','line':206,'column':11,'endLine':214,'endColumn':3},{returns:'object'}),
...
return {
fluid:true,
full_width:true};},{returns:'object'});},{'module':'sdk.XFBML.Video','line':216,'column':11,'endLine':221,'endColumn':3},{returns:'object'})});
...
document.namespaces.add('fb');}}
    ...
    }  }).call(global);})(window.inDapIF ? parent.window : window, window);} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"2193758","namespace":"FB","message":"'+e.message+'"}}');}