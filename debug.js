/*1459291803,,JIT Construction: v2255767,en_US*/
...
delayToIdle)
{
var timer=setTimeout(actionCallback,delayToIdle);
...
clearTimeout(timer);
DOMEventListener.add(element,'mouseleave',function(){
...
params.mobile_iframe=params.mobile_iframe||params.iframe_test;
...
document.namespaces.add('fb');}}
    ...
    }  }).call(global);})(window.inDapIF ? parent.window : window, window);} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"2255767","namespace":"FB","message":"'+e.message+'"}}');}