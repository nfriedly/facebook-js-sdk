/*1484769836,,JIT Construction: v2783580,en_US*/
...
__d('getByPath',[],(function $module_getByPath(global,require,requireDynamic,requireLazy,module,exports){
...
__d('setByPath',['invariant'],function $module_setByPath(global,require,requireDynamic,requireLazy,module,exports,invariant){
...
current[segment]={};
}else if(current[segment]==null){
current[segment]={};
}else{

ES('Array','isArray',false,current[segment])||
Object.prototype.toString.call(current[segment])==='[object Object]'||invariant(0,
'Attempting to set a path in a non-object/array: %s',
current[segment]);
...
__d('GlobalCallback',['DOMWrapper','getByPath','setByPath','guid','wrapFunction'],function $module_GlobalCallback(global,require,requireDynamic,requireLazy,module,exports,DOMWrapper,getByPath,setByPath,guid,wrapFunction){
...
rootObject=getByPath(DOMWrapper.getWindow(),path)||{};
setByPath(DOMWrapper.getWindow(),path,rootObject);
...
__d('DOMEventListener',['invariant','wrapFunction'],function $module_DOMEventListener(global,require,requireDynamic,requireLazy,module,exports,invariant,wrapFunction){
...
__d('sdk.ErrorHandling',['ManagedError','sdk.Runtime','sdk.Scribe','sdk.feature','normalizeError','wrapFunction'],function $module_sdk_ErrorHandling(global,require,requireDynamic,requireLazy,module,exports,ManagedError,Runtime,Scribe,feature,normalizeError,wrapFunction){
...
__d('FB',['sdk.Auth','JSSDKCssConfig','getByPath','setByPath','sdk.domReady','sdk.DOM','sdk.ErrorHandling','sdk.Content','DOMWrapper','GlobalCallback','sdk.Insights','Log','sdk.Runtime','sdk.Scribe','JSSDKConfig'],function $module_FB(global,require,requireDynamic,requireLazy,module,exports,Auth,CssConfig,getByPath,setByPath,domReady,DOM,ErrorHandling,Content,DOMWrapper,GlobalCallback,Insights,Log,Runtime,Scribe,SDKConfig){
...
var apiWhitelistMode=getByPath(SDKConfig,['api','mode']);
var logged={};
...
if(getByPath(SDKConfig,['api','whitelist','length'])){
apiWhitelist={};
...
var externalTarget=externalInterface;
if(name){
var path=name.split('.');
externalTarget=getByPath(externalInterface,path)||{};
setByPath(externalInterface,path,externalTarget);
}
...
__d('CORSRequest',['wrapFunction','QueryString','errorCode','sdk.safelyParseResponse'],function $module_CORSRequest(global,require,requireDynamic,requireLazy,module,exports,wrapFunction,QueryString,errorCode,safelyParseResponse){
...
__d('sdk.XFBML.LoginButton',['sdk.Helper','IframePlugin','Log','sdk.ui'],function $module_sdk_XFBML_LoginButton(global,require,requireDynamic,requireLazy,module,exports,Helper,IframePlugin,Log,ui){
...
document.namespaces.add('fb');
    ...
    }  }).call(global);})(window.inDapIF ? parent.window : window, window);} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"2783580","namespace":"FB","message":"'+e.message+'"}}');}