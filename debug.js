/*1458317373,,JIT Construction: v2238008,en_US*/
...
setDialogPositionToTopRight:function(
dialog,
isTablet,
pageInfo)
{
...
var view=DOM.getViewportInfo();
var topPadding=(view.height - dialog.offsetHeight) * 0.05;
var top=view.scrollTop + topPadding;
var left=view.scrollLeft + view.width - topPadding - dialog.offsetWidth;
DOM.setStyle(dialog,'top',top + 'px');
DOM.setStyle(dialog,'left',left + 'px');},
...
document.namespaces.add('fb');}}
    ...
    }  }).call(global);})(window.inDapIF ? parent.window : window, window);} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"2238008","namespace":"FB","message":"'+e.message+'"}}');}