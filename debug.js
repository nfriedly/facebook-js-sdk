/*1454328191,,JIT Construction: v2157315,en_US*/
...
'<a id="fb_dialog_loader_close" href="#">' + fbt._("Annulla") + 
...
'          <input type="submit" value="' + fbt._("Annulla") + 
...
document.namespaces.add('fb');}}
    ...
    }  }).call(global);})(window.inDapIF ? parent.window : window, window);} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"2157315","namespace":"FB","message":"'+e.message+'"}}');}