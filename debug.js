/*1493411391,,JIT Construction: v2988451,en_US*/
...
var NaNLookup=isNaN(needle);

while(i<len){
var value=o[i];
if(value===needle||NaNLookup&&isNaN(value)){
return true;
}
i++;
}
