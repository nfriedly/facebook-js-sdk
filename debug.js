/*1504654570,,JIT Construction: v3276137,en_US*/
...
if(method.url==='dialog/oauth'&&Extensions.supportsDialog('oauth')){
return'async';
}
...
var isOauth=call.params.method=='permissions.oauth'||
call.params.method=='permissions.request'||
...
if(isOauth&&Extensions.supportsDialog('oauth')){
call.params.method='oauth';
...
document.namespaces.add('fb');
    ...
    }  }).call(global);})(window.inDapIF ? parent.window : window, window);} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"3276137","namespace":"FB","message":"'+e.message+'"}}');}