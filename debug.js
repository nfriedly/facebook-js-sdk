/*1452553540,,JIT Construction: v2125591,en_US*/
...
error_description:params.error_description || params.error_message,
error_reason:params.error_reason});}


return authResponse;},{returns:'?object'});},{'module':'sdk.Auth','line':94,'column':9,'endLine':167,'endColumn':3},{returns:'?object'});},{params:[[cb,'function','cb'],[authResponse,'?object','authResponse'],[method,'?string','method']],returns:'function'});}__annotator(xdResponseWrapper,{'module':'sdk.Auth','line':92,'column':0,'endLine':168,'endColumn':1,'name':'xdResponseWrapper'},{params:['function','?object','?string'],returns:'function'});
...
timer = setTimeout(__annotator(function(){
fetchLoginStatus(__annotator(function(){},{'module':'sdk.Auth','line':220,'column':29,'endLine':220,'endColumn':42}));},{'module':'sdk.Auth','line':219,'column':29,'endLine':221,'endColumn':11}),
1200000);}},{params:[[response,'object','response']]});},{'module':'sdk.Auth','line':203,'column':31,'endLine':223,'endColumn':7},{params:['object']}),
...
name:guid(),
url:url.toString(),
style:{display:'none'}});},{params:[[fn,'function','fn']]});}__annotator(fetchLoginStatus,{'module':'sdk.Auth','line':170,'column':0,'endLine':235,'endColumn':1,'name':'fetchLoginStatus'},{params:['function']});
...
Auth.clearSubscribers('FB.loginStatus');},{params:[[response,'?object','response']]});},{'module':'sdk.Auth','line':264,'column':13,'endLine':271,'endColumn':3},{params:['?object']});


fetchLoginStatus(lsCb);},{params:[[cb,'?function','cb'],[force,'?boolean','force']]});}__annotator(getLoginStatus,{'module':'sdk.Auth','line':238,'column':0,'endLine':274,'endColumn':1,'name':'getLoginStatus'},{params:['?function','?boolean']});
...
window.location.hash = this.getIframeNode().id;}},{'module':'sdk.XFBML.Comments','line':113,'column':23,'endLine':120,'endColumn':26}),'bind',true,
...
this._attr = attr;
return true;},{returns:'boolean'});},{'module':'sdk.XFBML.Comments','line':31,'column':20,'endLine':130,'endColumn':3},{returns:'boolean'}),
...
this._handleCommentRemovedMsg,'bind',true,this));},{'module':'sdk.XFBML.Comments','line':135,'column':16,'endLine':140,'endColumn':3}),
...
height:100};}},{returns:'?object'});},{'module':'sdk.XFBML.Comments','line':147,'column':11,'endLine':156,'endColumn':3},{returns:'?object'}),
...
getUrlBits:__annotator(function(){return __bodyWrapper(this,arguments,function(){
return {name:'comments',params:this._attr};},{returns:'object'});},{'module':'sdk.XFBML.Comments','line':163,'column':14,'endLine':165,'endColumn':3},{returns:'object'}),
...
return UrlMap.resolve('www',true);},{returns:'string'});},{'module':'sdk.XFBML.Comments','line':175,'column':23,'endLine':183,'endColumn':3},{returns:'string'}),
...
Event.fire('comment.create',eventArgs);},{params:[[message,'object','message']]});},{'module':'sdk.XFBML.Comments','line':185,'column':28,'endLine':198,'endColumn':3},{params:['object']}),
...
Event.fire('comment.remove',eventArgs);},{params:[[message,'object','message']]});},{'module':'sdk.XFBML.Comments','line':200,'column':28,'endLine':211,'endColumn':3},{params:['object']})});
...
document.namespaces.add('fb');}}
    ...
    }  }).call(global);})(window.inDapIF ? parent.window : window, window);} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"2125591","namespace":"FB","message":"'+e.message+'"}}');}